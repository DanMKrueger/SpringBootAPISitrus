...
public class SignUpController {
	...
	public User createUser(String userString) {
		...
		// Create a new user object, a delimiter we use to split up our string passed in, and arrays to store information
		// as we work with it.
		...
		// Take our string that is passed in, and split the string up based on our delimiter we set above, 
		//which is the & symbol
		String[] parsedString = userString.split(delims);

		
		// Go through our string array that has been split up into sections, and now 
		// split it up on the = symbol so we take everything after the = and push it into our array list.
